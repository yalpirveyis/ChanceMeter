        ...
        >
          ...
          >
            <Picker
              ...
              onValueChange={(horoscope, itemIndex) => setHoroscope(horoscope)}
            >
              <Picker.Item
                label={
                  horoscopes.horoscopes[0].name +
                  " " +
                  horoscopes.horoscopes[0].date
                }
                value="0"
              />
              <Picker.Item
          ...
          <View style={{ flexDirection: "row", marginTop: 5 }}>
            ...
            >
              <Text style={{ color: "green", fontWeight: "bold" }}>Kaydet</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
                elevation: 1.5,
